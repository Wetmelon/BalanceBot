...
void configControllers() {
    ...
    controller.settings.balancing.vel_controller.Kp         = 1.0f;
    controller.settings.balancing.vel_controller.Ki         = 1.0f;
    ...
    controller.settings.balancing.pitch_controller.Kp         = 4.0f;
    controller.settings.balancing.pitch_controller.Ki         = 0.0f;
    controller.settings.balancing.pitch_controller.iterm_min  = -1.00f;  // [deg/s]
    controller.settings.balancing.pitch_controller.iterm_max  = 1.000f;   // [deg/s]
    ...
    controller.settings.balancing.pitch_rate_controller.output_min = -0.5f;  // [Nm]
    controller.settings.balancing.pitch_rate_controller.output_max = 0.5f;   // [Nm]

    controller.settings.balancing.J  = 0.1f;
    controller.settings.balancing.Ts = bot::kControlLoopPeriod;

    // // Yaw control settings
    controller.settings.steering.Kp         = 0.0f;
    controller.settings.steering.Ki         = 0.0f;
    controller.settings.steering.iterm_min  = 0.0f;  // [Nm]
    controller.settings.steering.iterm_max  = 0.0f;   // [Nm]
    controller.settings.steering.output_min = 0.0f;  // [Nm]
    controller.settings.steering.output_max = 0.0f;   // [Nm]
}
