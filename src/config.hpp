...
void configControllers() {
    ...
    controller.settings.balancing.vel_controller.Kp         = 60.0f;  // [deg/(m/s)] - body pitch / CoM velocity error
    ...
    controller.settings.balancing.vel_controller.output_min = -30.0f;  // [deg]
    controller.settings.balancing.vel_controller.output_max = 30.0f;   // [deg]
