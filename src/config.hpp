...
void configControllers() {
    ...
    controller.settings.balancing.vel_controller.Kp         = 0.0f;    // [deg/(m/s)] - body pitch / CoM velocity error
    ...
    controller.settings.balancing.pitch_controller.Kp         = 1.0f;    // [(deg/s) / deg] - body pitch rate / body pitch error
    ...
    controller.settings.balancing.pitch_rate_controller.Kp         = 0.002f;   // [Nm/(deg/s)] - wheel torque / body pitch rate error
