...
class BNO080 {
   ...
   private:
    ...
    const int16_t rotationVector_Q1         = 14;
    const int16_t rotationVectorAccuracy_Q1 = 12;  // Heading accuracy estimate in radians. The Q point is 12.
    const int16_t accelerometer_Q1          = 8;
    const int16_t linear_accelerometer_Q1   = 8;
    const int16_t gyro_Q1                   = 9;
    const int16_t magnetometer_Q1           = 4;
    const int16_t angular_velocity_Q1       = 10;
    const int16_t gravity_Q1                = 8;
};